...
static int StringToVK(const std::string& str) {
	...
	static const std::unordered_map<std::string, int> g_virtualKeys = {
		// Mouse buttons
		...
		// Control keys
		{"ALT", VK_MENU}, {"CTRL", VK_CONTROL}, // Aliases
		...
		{"CAPITAL", VK_CAPITAL}, {"ESCAPE", VK_ESCAPE},
		{"SPACE", VK_SPACE},

		// Navigation keys
		{"PRIOR", VK_PRIOR}, {"NEXT", VK_NEXT}, {"END", VK_END},
		{"HOME", VK_HOME}, {"LEFT", VK_LEFT}, {"UP", VK_UP},
		...
		// OEM keys
		{"OEM_1", VK_OEM_1}, {"OEM_PLUS", VK_OEM_PLUS},
		{"OEM_COMMA", VK_OEM_COMMA}, {"OEM_MINUS", VK_OEM_MINUS},
		{"OEM_PERIOD", VK_OEM_PERIOD}, {"OEM_2", VK_OEM_2},
...
const char* hotkey::GetVKNameFromCode(int vkCode) {
	static const std::map<int, std::string> g_vkCodeToName = {
		...
		{VK_CLEAR, "VK_CLEAR"}, {VK_RETURN, "VK_RETURN"},
		...
		{VK_DOWN, "VK_DOWN"}, {VK_SELECT, "VK_SELECT"},
		{VK_PRINT, "VK_PRINT"}, {VK_EXECUTE, "VK_EXECUTE"},
		{VK_SNAPSHOT, "VK_SNAPSHOT"}, {VK_INSERT, "VK_INSERT"},
		{VK_DELETE, "VK_DELETE"}, {VK_HELP, "VK_HELP"},
		{VK_LWIN, "VK_LWIN"}, {VK_RWIN, "VK_RWIN"},
		{VK_APPS, "VK_APPS"}, {VK_SLEEP, "VK_SLEEP"},
		{VK_NUMPAD0, "VK_NUMPAD0"}, {VK_NUMPAD1, "VK_NUMPAD1"},
		{VK_NUMPAD2, "VK_NUMPAD2"}, {VK_NUMPAD3, "VK_NUMPAD3"},
		{VK_NUMPAD4, "VK_NUMPAD4"}, {VK_NUMPAD5, "VK_NUMPAD5"},
		{VK_NUMPAD6, "VK_NUMPAD6"}, {VK_NUMPAD7, "VK_NUMPAD7"},
		...
		{VK_F13, "VK_F13"}, {VK_F14, "VK_F14"}, {VK_F15, "VK_F15"},
		{VK_F16, "VK_F16"}, {VK_F17, "VK_F17"}, {VK_F18, "VK_F18"},
		{VK_F19, "VK_F19"}, {VK_F20, "VK_F20"}, {VK_F21, "VK_F21"},
		{VK_F22, "VK_F22"}, {VK_F23, "VK_F23"}, {VK_F24, "VK_F24"},
